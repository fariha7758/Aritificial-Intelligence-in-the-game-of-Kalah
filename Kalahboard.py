...
class Kalah:
    ...
    def game_loop(self):
        ...
        print("moves:", self.player1_count, self.player2_count)
        return res, self.player_1.board[0], self.player_2.board[0], self.player1_count, self.player2_count, total_time
